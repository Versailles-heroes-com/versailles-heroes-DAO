...
dao install $DAO_ADDRESS create-guild-voting.open.aragonpm.eth --app-init-args $VOTING_ESCROW 510000000000000000 500000000000000000 3600 2500 1000000 10 1000000 100000000 10 1000 --env $DEPLOY_ENV --ipfs-rpc https://ipfs.infura-ipfs.io:5001/ --ipfs-gateway https://ipfs.infura-ipfs.io/ipfs
